...
6. For void-grubs video/article companions: link `/grubs` and pin `studies/grubs/grubs_decision_numbers.json`.

Do not ship Slip Composer, fair odds, or timelines in the default pack.
