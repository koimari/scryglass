...
export const TOOLS: ToolSpec[] = [
  ...
  { name: "query_drafts", description: "Rank team draft scores in either direction or compare two named teams over their published draft history. Use for best, worst, top, bottom, named-team, between-team, versus-team, or league-specific draft-score questions. The response states the league or tier scope, active profile window, and sample floor.", args: [{ name: "q", description: "the complete original team draft-score question" }] },
  { name: "leaderboards", description: "Top players by A-grade games, rating, or win rate; top teams; or draft rankings (teams by draft win share, players by best-available rate from published bans and tier pools); optionally filtered by role and competitive tier.", args: [{ name: "category", description: "a_grades | rating | win_rate | teams | teams_draft | players_draft" }, { name: "role", description: "top | jng | mid | bot | sup (optional)" }, { name: "tier", description: "tier1 | tier2 | tier3 (optional; use tier1 by default)" }, { name: "limit", description: "number of results (optional)" }] },
  ...
  { name: "tier", description: "Patch-wide champion tier list, optionally per role.", args: [{ name: "role", description: "top | jng | mid | bot | sup (optional)" }, { name: "patch", description: "public patch such as 26.16 (optional)" }] },
