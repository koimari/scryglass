...
export const TOOLS: ToolSpec[] = [
  ...
  { name: "leaderboards", description: "Top players by A-grade games, rating, or win rate; top teams; or draft rankings (teams by draft win share, players by the share of scored drafts where their pick led their side); optionally filtered by role and competitive tier.", args: [{ name: "category", description: "a_grades | rating | win_rate | teams | teams_draft | players_draft" }, { name: "role", description: "top | jng | mid | bot | sup (optional)" }, { name: "tier", description: "tier1 | tier2 | tier3 (optional; use tier1 by default)" }, { name: "limit", description: "number of results (optional)" }] },
