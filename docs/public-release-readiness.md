...
Current production evidence for `v2026.08.14.181106`:

- application commit: `6fa61f1d987a93adbe1e4ab6be75adea1895f211`;
- worker commit recorded by diagnostics: `dace1bb60d5b9f49144d7602457a6e10c822b5ad`;
- manifest and active release IDs: `v2026.08.14.181106`;
- active assets: 22 Storage objects, 145,019,319 bytes, zero inline rows, zero Draft rows, zero invalid metadata rows;
- source observation: `2026-08-14T09:09:44+00:00`;
- health at `2026-08-14T20:43:37.530Z`: `ok`, `idle`, `stale: false`.

The release stays on HOLD while the worker checkout proof, rollback drill, source-rights records, and independent Draft Score promotion record remain incomplete.
